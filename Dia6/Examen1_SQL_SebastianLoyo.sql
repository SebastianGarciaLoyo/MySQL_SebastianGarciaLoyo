...
-- Creando y usando base de datos Colegio

create database Colegio;

use Colegio;

-- Creando la tabla profesor
...
create table asignatura(
	...
	tipo enum("bàsica","obligatoria","optativa") not null,
...
-- creando la tabla curso_escolar
...
-- creando la tabla alumno_se_matricula_asignatura
